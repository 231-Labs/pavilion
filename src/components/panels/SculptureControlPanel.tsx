      ...
      {!isExpanded && (
        ...
        >
          <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5 text-white/80">
            <path d="M20 7H4a2 2 0 00-2 2v10a2 2 0 002 2h16a2 2 0 002-2V9a2 2 0 00-2-2zM12 2v5M8 7V2M16 7V2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </button>
      )}
